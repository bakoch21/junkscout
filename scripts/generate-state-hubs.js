...
const STATES = [
  ...
  { slug: "arizona", file: path.join("arizona", "index.html") },
  ...
  { slug: "north-carolina", file: path.join("north-carolina", "index.html") },
  { slug: "washington", file: path.join("washington", "index.html") },
];
